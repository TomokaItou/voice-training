...
const pitchInitialNoiseFloorRms = pitchMinEnergyThreshold / pitchAdaptiveEnergyMultiplier;
const pitchNoiseFloorRiseAlpha = 0.06;
const pitchNoiseFloorFallAlpha = 0.22;
const pitchNoiseFloorRiseGuardMultiplier = 1.25;
...
const vocalScoreDefaultTempo = 120;
const vocalScoreMinNoteDurationMs = 140;
const vocalScoreMinRestDurationMs = 180;
const vocalScoreSameNoteToleranceCents = 70;
const vocalScoreNewNoteThresholdCents = 120;
const vocalScoreMaxMergeGapMs = 90;
const vocalScoreQuantizeStepMs = 125;
