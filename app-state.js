...
let adaptiveNoiseFloorRms = pitchInitialNoiseFloorRms;
...
let s88TargetSegments = [];
let s88TargetFrames = [];
let s88LastMatchSummary = null;
let s88TargetLibraryId = null;
let s88TargetSourceName = '';
let s88UserProfile = null;
let s88TrainingPhase = 'needs-target';
let s88PracticeActive = false;
